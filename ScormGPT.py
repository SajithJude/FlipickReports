...
st.metric(label='Total Number of Learners:', value=total_learners, delta="1.3%")
st.metric(label='Total Number of Attempts:', value=total_attempts, delta="-1.5%")
st.metric(label='Average Time Spent', value=ahrs, delta="7%")
